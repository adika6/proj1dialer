...
import com.merebapps.commons.adapters.ManageBlockedNumbersAdapter
import com.merebapps.commons.dialogs.AddBlockedNumberDialog
...
import com.merebapps.commons.helpers.BlockedNumbersExporter.ExportResult
import com.merebapps.commons.interfaces.RefreshRecyclerViewListener
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val blockTitleRes = if (baseConfig.appId.startsWith("com.merebapps.dialer")) R.string.block_unknown_calls else R.string.block_unknown_messages
