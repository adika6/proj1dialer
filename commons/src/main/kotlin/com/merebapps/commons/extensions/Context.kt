...
import com.merebapps.commons.models.AlarmSound
...
// someg helper functions were taken from https://github.com/iPaulPro/aFileChooser/blob/master/aFileChooser/src/com/ipaulpro/afilechooser/utils/FileUtils.java
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.merebapps.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.merebapps."))

fun Context.getProUrl() = "https://play.google.com/store/apps/details?id=${baseConfig.appId.removeSuffix(".debug")}.pro"

fun Context.getStoreUrl() = "https://play.google.com/store/apps/developer?id=Mereb+Apps"
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.merebapps.contacts") && !packageName.startsWith("com.merebapps.dialer")) {
        true
    } else if ((packageName.startsWith("com.merebapps.contacts") || packageName.startsWith("com.merebapps.dialer")) && isQPlus()) {
